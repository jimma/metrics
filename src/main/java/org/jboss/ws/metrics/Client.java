...
public final class Client implements Runnable {
    ...
    private int invocationNum = 10000;
    ...
    private Client(String name, SOAPService service, int invocationNum) {
        this.username = name;
        this.service = service;
    ...
    public static void main(String args[]) throws Exception {
        ...
        URL wsdlURL = new URL(Client.class.getClassLoader().getResource(".") + "../../src/main/config/hello_world.wsdl");        
